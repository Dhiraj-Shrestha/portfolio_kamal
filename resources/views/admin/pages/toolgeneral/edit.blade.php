    ...
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title">Edit General Tool</h4>

                    <form class="forms-sample" action="{{ route('toolbox.general.update', $data->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <img src="/ToolGeneral/{{ $data->image }}" alt=""
