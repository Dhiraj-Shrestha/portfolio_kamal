    ...
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title">Edit Back-end Tool</h4>

                    <form class="forms-sample" action="{{ route('toolbox.backend.update', $data->id) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <img src="/ToolBackend/{{ $data->image }}" alt=""
